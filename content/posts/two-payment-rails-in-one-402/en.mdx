---
title: "Two Payment Rails in One HTTP 402"
date: "2026-09-09"
tags: ["AI", "Payments", "x402", "Engineering"]
excerpt: "An ordinary rental site started charging software: one 402 challenge carrying USDC on both Base and Solana, the four gates that keep the second rail honest, and the three bugs that only real money could find."
---
